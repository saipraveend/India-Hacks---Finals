...
def keycommands(x):
    ...
    if x == 19936:                              # RIGHT ARROW KEY
        ...
        s.sendall("RIGHT")
        return True
    if x == 18656:                              # LEFT ARROW KEY
        print 'UP ARROW KEY'
        s.sendall("UP")
        return True
    if x == 20704:                              # RIGHT ARROW KEY
...
def commandloop():
    ...
    print about()
    print 'Start Pressing the arrow keys to control the Robot...'
    interpreting=True
    while interpreting:
...
if __name__ == '__main__':
    while 1:
        ...
        print "\n Press [1] to control the robot and [3] to exit. Press [2] at your own risk.. "
        x=keypress()
